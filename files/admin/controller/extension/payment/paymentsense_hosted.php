	...
	public function index() {
		...
		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/payment/paymentsense_hosted', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
				
		$data['action'] = $this->url->link('extension/payment/paymentsense_hosted', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->template = 'extension/payment/paymentsense_hosted.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
		...
		$this->response->setOutput($this->load->view('extension/payment/paymentsense_hosted.tpl', $data));
